...
import java.awt.GridBagConstraints; // Displays componentsas a grid
...
public class SwingGrid29 extends JFrame {
	
	JButton but1, but2, but3, but4, but5, but6, but7, but8, 
		but9, but0, butPlus, butMinus, clearAll;
	...
	public SwingGrid29() {
		...
		// FILL overwrites manual x and y positions********************
		...
		// Adding buttons using the Grid Layout (withouth Bag)
		/*
		thePanel.add(but1);
		thePanel.add(but2);
		thePanel.add(but3);
