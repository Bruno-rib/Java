...
/*
 * awt.Dimension allows to store heights and widths
 * 
 * allows to ask different questions of the operating system
 * 
 * Swing allows you to create Graphical User Interfaces(GUI)
...
public class Swing20 extends JFrame {
	...
	public Swing20() {
		...
		//panel is a subWindow inside the frame
		JPanel thePanel = new JPanel();
		
		//How to create a label with its text -------------
		JLabel label1 = new JLabel("Tell me something");
		
		//How to change the text for the label (overwrote text above)
		label1.setText("New Text");
		
		//How to create a tool top for the label
		label1.setToolTipText("Shows if you hover mouse 1");
		...
		//How to change the text for the label (overwrote "send" from above)
		button1.setText("New Button");
		
		//How to create a tool tip for the label
		button1.setToolTipText("Hover mouse 2");
		
		//ADDS THE BUTTON TO PANEL---------------------- button
		thePanel.add(button1);
		
		//How to add a textfield -------------------------
		JTextField textField1 = new JTextField("Type Here", 15);
		
		//Change the size of the text field (overwrote 15 value initialized)
		textField1.setColumns(10);
		
		//Change the initial value of the text field (overwrote "Type Here")
		textField1.setText("New Text Here");
		
		//Change the tool tip for the text field
		textField1.setToolTipText("Hover mouse 3");
		
		//ADD TEXTFIELD---------------------------------------------textfield
		thePanel.add(textField1);
		
		//How to add text area ------------------------------------
		...
		//mouse hover
		textArea1.setToolTipText("Hover mouse 4");
		...
		//Gives focus to the textfield (so you can star typing)
