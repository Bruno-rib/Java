...
/*
 * By using therads you can execute multiple blocks
...
public class GetTime17 extends Thread{
	/*
	 * All of the code that the thread executes must be in 
	 * the run method, or be in a method called for 
	...
	public void run() {
		...
		for (int i = 1; i <= 20; i++) {
			 ...
			 * code to catch the InterpretedException exception
			 * sleep pauses thread execution for 2 seconds (2000 milliseconds) below
			 */
