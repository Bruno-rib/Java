...
public class Swing27 extends JFrame {
	...
	private DefaultMutableTreeNode addAFile(String fileName, DefaultMutableTreeNode
			parentFolder) {
	...
	private class ListenForButton implements ActionListener {
		...
		public void actionPerformed(ActionEvent e) {
			if (e.getSource() == button1) {
				...
				outputString += "The parent is:" + theFile.getParent() + "\n";
				
				// Get the next node
				outputString += "The next node is: " + theFile.getNextNode() + "\n";
				...
				JOptionPane.showMessageDialog(Swing27.this, outputString, "Information", JOptionPane.INFORMATION_MESSAGE);
