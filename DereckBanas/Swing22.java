...
public class Swing22  extends JFrame {
	...
	public Swing22 () {
		...
		//the JPanel contain all the components for your frame
		JPanel thePanel = new JPanel();
		
		//-------------------------------------------------------------
		//Create a button with Calculate on it
		button1 = new JButton("Calculate");
		
		//create an instance to listen to events to handle events
		...
		//Create a new panel to hold radio buttons *********************** subPanel JPanel
		...
		// Defines the minimum space between mahor ticks
		...
		public void actionPerformed(ActionEvent e) {
			...
			if (e.getSource() == button1) {
				...
				try {
					...
					JOptionPane.showMessageDialog(Swing22.this, "Please Enter the Right Info", "Error", JOptionPane.ERROR_MESSAGE);
				...
				//If the dollar is selected in the checkbox print the number as currncy
				if (dollarSign.isSelected()) {
					
					// Defines that you want to format a number with $ and commas
					NumberFormat numFormat = NumberFormat.getCurrencyInstance();
					
					JOptionPane.showMessageDialog(Swing22.this, numFormat.format(totalCalc), "Solution", JOptionPane.INFORMATION_MESSAGE);
				} else {
					JOptionPane.showMessageDialog(Swing22.this, totalCalc, "Solution", JOptionPane.INFORMATION_MESSAGE);
				}
			}
		}
	}
	...
	public static double multiplyNums (double number1, double number2, int howMany) {
		double total = 0;
		int i = 1;
