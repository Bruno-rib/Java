...
public class Swing26 extends JFrame {
	...
	public Swing26 () {
		...
		Dimension f = spinner1.getPreferredSize();
		f.width = 60;
		spinner1.setPreferredSize(f);
	...
	private class ListenForButton implements ActionListener {
		...
		public void actionPerformed(ActionEvent e) {
			...
			if (e.getSource() == button1) {
				...
				JOptionPane.showMessageDialog(Swing26.this, outputString, "Information", JOptionPane.INFORMATION_MESSAGE);
