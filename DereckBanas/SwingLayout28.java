...
public class SwingLayout28 extends JFrame {
...
/*               // FLOW LAYOUT
		...
		//Define the flow layout aligment
		// FlowLayout.RIGHT, FlowLayout.CENTER
		
		thePanel.setLayout(new FlowLayout(FlowLayout.LEFT, 30, 10));
...
/*
		 ...
		 theBox.add(button4);
		 */
		 // You can also separate the components with struts (pixels in between)
		...
		// There is also a createBerticalGlue
