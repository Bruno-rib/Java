...
public class Swing24 extends JFrame {
	...
	public Swing24() {
		...
		/*
		 * Remove the item named Dexter --> favoriteShows.removeItem("Dexter");
		 * Remove the item at index 1 --> favoriteShows.removeItemAt(1);
		 * Remove all items --> favoriteShows.removeAllItems();
		 */
	...
	private class ListenForButton implements ActionListener{
		...
		public void actionPerformed(ActionEvent e) {
			...
			if (e.getSource() == button1) {
				...
				JOptionPane.showMessageDialog(Swing24.this, infoOnComponent, "Information", JOptionPane.INFORMATION_MESSAGE);
